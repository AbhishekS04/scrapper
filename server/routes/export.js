  ...
  try {
    ...
    const exportData = {
      ...
      results: results.map(r => ({
        ...
        comments: r.comments,
        leakedData: r.leakedData,
        securityInfo: r.securityInfo,
        ...
        openAPIs: r.openAPIs,
        pageFingerprint: r.pageFingerprint,
        languageInfo: r.languageInfo,
        copyright: r.copyright,
        schemaOrg: r.schemaOrg,
        microdata: r.microdata,
        linkRelations: r.linkRelations,
        responseHeaders: r.responseHeaders,
        siteIntel: r.siteIntel,
